...
class Data {
  ...
  static List<SocialButton2Data> socialData2 = [
    SocialButton2Data(
      title: StringConst.HOTMAIl,
      iconData: FontAwesomeIcons.microsoft,
      url: StringConst.HOTMAIl_ID,
  ...
  static List<StatItemData> statItemsData = [
    StatItemData(value: 5, subtitle: StringConst.HAPPY_COMPANIES),
  ...
  static List<ProjectCategoryData> projectCategories = [
    ...
    ProjectCategoryData(title: StringConst.ANDROID_APPLICATIONS, number: 2),
    ProjectCategoryData(title: StringConst.FLUTTER_APPLICATIONS, number: 2),
  ...
  static List<FayyazCardData> fayyazCardData = [
    FayyazCardData(
      title: StringConst.ANDROID_DEVELOPER,
      subtitle: StringConst.ANDROID_DEVELOPER_DESC,
    ...
    FayyazCardData(
      title: StringConst.UPWORK,
      subtitle: StringConst.UPWORK_DESC,
      leadingIcon: Icons.done,
      trailingIcon: Icons.chevron_right,
  ...
  static List<ProjectData> allProjects = [
    ProjectData(
      ...
      category: StringConst.FLUTTER_APPLICATIONS,
    ...
    ProjectData(
      ...
      category: StringConst.ANDROID_APPLICATIONS,
      projectCoverUrl: ImagePath.PORTFOLIO_5,
      width: 0.2375,
    ),
    ProjectData(
      title: StringConst.PORTFOLIO_KP_TITLE,
      category: StringConst.ANDROID_APPLICATIONS,
      projectCoverUrl: ImagePath.PORTFOLIO_5,
      width: 0.2375,
    ),
  ...
  static List<ProjectData> android = [
    ProjectData(
      title: StringConst.PORTFOLIO_5_TITLE,
      category: StringConst.ANDROID_APPLICATIONS,
      projectCoverUrl: ImagePath.PORTFOLIO_5,
  ...
  static List<ProjectData> flutter = [
    ProjectData(
      title: StringConst.PORTFOLIO_1_TITLE,
      category: StringConst.FLUTTER_APPLICATIONS,
      projectCoverUrl: ImagePath.PORTFOLIO_1,
