...
import 'package:fayyaz/presentation/widgets/circular_container.dart';
import 'package:fayyaz/presentation/widgets/fayyaz_card.dart';
...
List<Widget> buildCardRow({
  ...
  required List<FayyazCardData> data,
