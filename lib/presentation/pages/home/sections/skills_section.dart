...
import 'package:fayyaz/presentation/widgets/skill_card.dart';
import 'package:fayyaz/presentation/widgets/skill_level.dart';
...
class _SkillsSectionState extends State<SkillsSection>
                ...
                child: Column(
                  children: [
                    ContentArea(
                      ...
                      child: _buildFayyazSm(width: contentAreaWidthSm),
                    ),
                    SpaceH40(),
                    ContentArea(
                      width: contentAreaWidthSm,
                ...
                child: Row(
                  children: [
                    ContentArea(
                      ...
                      child: _buildFayyazLg(width: contentAreaWidthLg),
                    ),
                    ContentArea(
                      width: contentAreaWidthLg,
  ...
  Widget _buildFayyazLg({required double width}) {
    return Container(
      child: Row(
        children: [
          Expanded(
  ...
  Widget _buildFayyazSm({required double width}) {
