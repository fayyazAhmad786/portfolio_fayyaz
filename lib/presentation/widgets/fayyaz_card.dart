...
class FayyazCard extends StatefulWidget {
  FayyazCard({
    this.leading,
    this.title,
    this.subtitle,
  ...
  @override
  _FayyazCardState createState() => _FayyazCardState();
}

class _FayyazCardState extends State<FayyazCard>
