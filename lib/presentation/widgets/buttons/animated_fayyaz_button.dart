...
class AnimatedFayyazButton extends StatefulWidget {
  final String title;
  ...
  @override
  _AnimatedFayyazButtonState createState() => _AnimatedFayyazButtonState();
}

class _AnimatedFayyazButtonState extends State<AnimatedFayyazButton> {
